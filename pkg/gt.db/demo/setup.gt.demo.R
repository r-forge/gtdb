...
# load descriptions of 270 HapMap subjects

data(hapmap)
mk.subject('Demo', hapmap.subjects)

# set up HapMap subject attributes

mk.subject.attr(
  'Demo', hapmap.subjects[-1],
  c('Plate: CEPH Utah, Yoruban from Nigeria, Japanese + Chinese',
    'Panel: CEPH Utah, Yoruban, Japanese, Chinese',
    'Name of Father', 'Name of Mother')
)
store.subject.data('Demo', hapmap.subjects)
...
mk.mapping('Demo_Set_2', 'Demo_Set_2_b36',
           'Platform 2 Mapping to NCBI Build 36')
