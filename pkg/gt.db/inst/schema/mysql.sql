...
(
  dataset_id integer auto_increment primary key,
...
(
  subject_attr_id integer auto_increment primary key,
  project_id integer not null,
  name varchar(64) not null,
  datatype varchar(64),
  levels varchar(1000),
...
create table sample
(
  sample_id integer auto_increment primary key,
...
(
  sample_attr_id integer auto_increment primary key,
  dataset_id integer not null,
  name varchar(64) not null,
  datatype varchar(64),
  levels varchar(1000),
...
(
  assay_data_id integer auto_increment primary key,
  dataset_id integer not null,
  assay_id integer not null,
...
create table prcomp
(
  prcomp_id integer auto_increment primary key,
  dataset_id integer not null,
  name varchar(64) not null,
  description varchar(255),
  fn_call varchar(255),
